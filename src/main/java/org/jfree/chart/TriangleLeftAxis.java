...
public class TriangleLeftAxis extends TriangleAxis {
    public TriangleLeftAxis(String label){
        super(label);
    }
    public TriangleLeftAxis(){
        super();
    }
    ...
    protected AxisState drawLabel(String label, Graphics2D g2,
        ...
        AffineTransform t = AffineTransform.getRotateInstance(
                sizeAngle, labelBounds.getCenterX(),
    ...
    protected float[] calculateAnchorPoint(ValueTick tick,
        ...
        result[0] = (float) (cursor - insets.getLeft() - 2.0 + offsetX);
        return result;
    }
    ...
    protected void drawAxisLine(Graphics2D g2, double cursor,
        ...
        double endY = startY - Math.tan(Math.PI / 3.0) * width / 2.0 ;
